...
struct OnboardingView: View {
    ...
    private let pages: [Page] = [
        ...
        Page(symbol: "sun.max",
             ...
             body: "Shadow Lens projects physically plausible shadows from the proxy objects you place. It does not reconstruct the real world — results are an approximation to help you plan."),
